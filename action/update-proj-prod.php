...
if($sql):
	header("location:../dashboard/pm.php?update-proj=success");
	else:
	header("location:../dashboard/pm.php?update-proj=fail");
	endif;
	
else:

header("location:../dashboard/pm.php?error=incomplete");
