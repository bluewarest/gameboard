...
if($sql):
	header("location:../dashboard/pm-gb.php?update-proj=success");
	else:
	header("location:../dashboard/pm-gb.php?update-proj=fail");
	endif;
	
else:

header("location:../dashboard/pm-gb.php?error=incomplete");
