...
$sql2 = mysql_query("INSERT INTO company (name) VALUES ('".$company."')");
$company_id =mysql_insert_id();
$sql = mysql_query("INSERT INTO registration (username,email,firstname,lastname,phone,position,company,address,city,state,zipcode,country,registration_key) VALUES ('".$username."','".$email."','".$firstname."','".$lastname."','".$phone."','".$position."','".$company_id."','".$address."','".$city."','".$state."','".$zipcode."','".$country."','".$registration_key."')");
...
$message2.='<br />http://gameboard.neverbluecrm.com/?c='.$registration_key;
					    //mail("usmanpervez1992@gmail.com,jbornamann@outlook.com", $subject2, $message2, implode("\r\n",$headers2));	
 mail("raidthelibra@gmail.com,jimmy@express-business-solutions.com,josh@thestrategicpoint.com, monicakilian1@me.com,usmanpervez1992@gmail.com,jbornamann@outlook.com", $subject2, $message2, implode("\r\n",$headers2));	
