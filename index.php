...
<div id="topBar"><!--a href="./"><img src="img/spm-logo.png" alt="" /></a>-->
 	 ...
 	 <div class="row blue">
 		...
 		<div class="col-md-6  center-block" style="font-family: myFirstFont; letter-spacing: 25px; font-size: 70px; font-weigth: bold;  text-align:center;  color: white;">Gameboard</div>
 		<div class="col-md-3"></div>
 	</div>
